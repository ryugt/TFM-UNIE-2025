...
archivo_entrada = "cicids2017_completo.csv"

# 2. Columnas a conservar (tu lista de 20 features)
...
df_filtrado.to_csv("cicids2017_reducido.csv", index=False)

print(f"[OK] Archivo limpio guardado como 'cicids2017_reducido.csv' con {len(columnas_presentes)} columnas.")
